...
export const pureAddUser = (name: string, setError: Function, setName: Function, addUserCallback: Function) => {
    ...
    return (name.trim() === '') ? setError('Ошибка! Введите имя!') : addUserCallback(name) & setName('')
...
const GreetingContainer: React.FC<GreetingContainerPropsType> = ({
    ...
    const lastUserName =  totalUsers > 0 ? users[users.length - 1].name : undefined // need to fix
    return (
        <Greeting
            name={name}
